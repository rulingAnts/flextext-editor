...
en: {
  ...
  'panel.drive.how': 'Uploads go straight into YOUR Google Drive (connected as {email}); if that ever fails they automatically fall back to the shared relay folder.',
  'panel.drive.notConnected': 'No Google Drive connection found — uploads use the shared relay folder. Signing in with Google connects your Drive automatically.',
...
id: {
  ...
  'panel.drive.how': 'Unggahan masuk langsung ke Google Drive ANDA (terhubung sebagai {email}); jika gagal, otomatis beralih ke folder relai bersama.',
  'panel.drive.notConnected': 'Koneksi Google Drive tidak ditemukan — unggahan memakai folder relai bersama. Masuk dengan Google akan menghubungkan Drive Anda secara otomatis.',
