#!/usr/bin/env bash
# Assemble the deployable origin for the flextext-recorder Worker. Runs via the wrangler.toml [build]
...
# feature branch overwrite https://record.flextext.app/ .
...
rm -rf public
mkdir -p public
cp -R ../../satellites/text-recorder/. public/
