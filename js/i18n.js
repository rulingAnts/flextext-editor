...
that too by routing all Drive transfers through the Worker.</p>
  ...
  'panel.signup.restore': 'Restore an existing account',
  'panel.signup.noWidget': 'Could not load the verification widget. Check your connection.',
  'panel.restore.title': 'Restore account',
  'panel.restore.intro': 'Paste the account ID and secret you saved. You will still need your passphrase to read data.',
  'panel.restore.id': 'Account ID',
  'panel.restore.secret': 'Account secret',
  'panel.restore.btn': 'Restore',
  'panel.restore.cancel': 'Cancel',
  'panel.restore.bad': 'Enter both the account ID and secret.',
  'panel.setpass.title': 'Set your passphrase',
  'panel.setpass.intro': 'This derives the key that encrypts every device’s data. It never leaves this device — there is no recovery if you forget it.',
  'panel.setpass.confirm': 'Confirm passphrase',
  'panel.setpass.btn': 'Set passphrase',
  'panel.setpass.warn': 'Write this passphrase down somewhere safe. It cannot be reset.',
  'panel.setpass.short': 'Use at least 8 characters.',
  'panel.setpass.mismatch': 'The two passphrases do not match.',
  'panel.unlock.title': 'Unlock your data',
  'panel.unlock.intro': 'Enter your passphrase to decrypt your devices’ data on this device.',
  'panel.unlock.ph': 'Passphrase',
  'panel.unlock.btn': 'Unlock',
  'panel.unlock.bad': 'Wrong passphrase.',
  ...
  'panel.up.local': 'local only',
  'panel.up.changed': 'changed',
  ...
  'panel.account.intro': 'Save these somewhere safe. With them plus your passphrase you can sign in on another device. There is no email recovery.',
  'panel.account.copy': 'Copy account secret',
  'panel.account.copied': 'Copied.',
  'panel.account.signout': 'Sign out of this device',
  'panel.account.confirmSignout': 'Sign out? You will need the account secret and passphrase to return.',
  ...
  'panel.f.convertKbps': 'Upload MP3 bitrate (kbps)',
  'panel.f.convertRate': 'Upload MP3 sample rate (Hz)',
...
lewat Worker.</p>
  ...
  'panel.signup.restore': 'Pulihkan akun yang sudah ada',
  'panel.signup.noWidget': 'Tidak dapat memuat widget verifikasi. Periksa koneksi Anda.',
  'panel.restore.title': 'Pulihkan akun',
  'panel.restore.intro': 'Tempel ID akun dan rahasia yang Anda simpan. Anda tetap perlu frasa sandi untuk membaca data.',
  'panel.restore.id': 'ID akun',
  'panel.restore.secret': 'Rahasia akun',
  'panel.restore.btn': 'Pulihkan',
  'panel.restore.cancel': 'Batal',
  'panel.restore.bad': 'Masukkan ID akun dan rahasianya.',
  'panel.setpass.title': 'Tetapkan frasa sandi',
  'panel.setpass.intro': 'Frasa ini menurunkan kunci yang mengenkripsi data semua perangkat. Frasa tidak pernah meninggalkan perangkat ini — tidak ada pemulihan jika Anda lupa.',
  'panel.setpass.confirm': 'Konfirmasi frasa sandi',
  'panel.setpass.btn': 'Tetapkan frasa sandi',
  'panel.setpass.warn': 'Catat frasa sandi ini di tempat aman. Tidak bisa diatur ulang.',
  'panel.setpass.short': 'Gunakan minimal 8 karakter.',
  'panel.setpass.mismatch': 'Kedua frasa sandi tidak sama.',
  'panel.unlock.title': 'Buka data Anda',
  'panel.unlock.intro': 'Masukkan frasa sandi untuk mendekripsi data perangkat Anda di sini.',
  'panel.unlock.ph': 'Frasa sandi',
  'panel.unlock.btn': 'Buka',
  'panel.unlock.bad': 'Frasa sandi salah.',
  ...
  'panel.up.local': 'hanya lokal',
  'panel.up.changed': 'berubah',
  ...
  'panel.account.intro': 'Simpan ini di tempat aman. Dengan ini plus frasa sandi, Anda bisa masuk di perangkat lain. Tidak ada pemulihan via email.',
  'panel.account.copy': 'Salin rahasia akun',
  'panel.account.copied': 'Tersalin.',
  'panel.account.signout': 'Keluar dari perangkat ini',
  'panel.account.confirmSignout': 'Keluar? Anda perlu rahasia akun dan frasa sandi untuk kembali.',
  ...
  'panel.f.convertKbps': 'Bitrate MP3 unggahan (kbps)',
  'panel.f.convertRate': 'Laju sampel MP3 unggahan (Hz)',
