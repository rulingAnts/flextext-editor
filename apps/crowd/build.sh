#!/usr/bin/env bash
# Assemble the deployable origin for the flextext-crowd Worker. Runs via the wrangler.toml [build]
...
# feature branch overwrite https://crowd.flextext.app/ .
...
rm -rf public
mkdir -p public
cp -R ../../satellites/crowd-recorder/. public/
