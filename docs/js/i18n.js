...
en: {
  ...
  'record.cap.dev.unknown': 'a microphone the phone did not name',
  ...
  'research.autoDelNote': 'A text is removed only after it has been marked finished (via the Finished button) AND confirmed on Drive — so nothing in progress is ever lost. Best for collecting recordings on a phone: frees storage and keeps the list to what still needs sending. (The Flextext Recorder app deletes after upload by default.)',
...
id: {
  ...
  'record.cap.dev.unknown': 'mikrofon yang tidak disebutkan ponsel',
