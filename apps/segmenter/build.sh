#!/usr/bin/env bash
# Assemble the deployable origin for the audio-segmenter Worker. Runs via the wrangler.toml [build]
...
# feature branch overwrite https://audio-segmenter.flextext.app/ .
...
rm -rf public
mkdir -p public
cp -R ../../satellites/audio-segmenter/. public/
