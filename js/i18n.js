...
en: {
  ...
  'recfmt.helpTech': '<b>Technical summary (for your archive).</b> By default this app captures the <b>raw</b> microphone signal — automatic gain, noise reduction, echo cancellation, and normalization are all <b>off</b> — in <b>mono</b>, at the device\'s native sample rate (usually 48 kHz), and stores it <b>losslessly and bit-faithfully</b> with no resampling, at the bit depth of your chosen format (24-bit by default). The only processing applied is whatever you deliberately switch on under "Microphone processing" in Settings.',
...
id: {
  ...
  'recfmt.helpTech': '<b>Ringkasan teknis (untuk arsip Anda).</b> Secara default aplikasi ini menangkap sinyal mikrofon <b>mentah</b> — penguatan otomatis, pengurangan noise, penghapusan gema, dan normalisasi semuanya <b>mati</b> — dalam <b>mono</b>, pada laju sampel asli perangkat (biasanya 48 kHz), dan menyimpannya secara <b>lossless dan setia-bit</b> tanpa resampling, pada kedalaman bit format pilihan Anda (24-bit secara default). Satu-satunya pemrosesan yang diterapkan adalah yang Anda aktifkan secara sengaja di "Pemrosesan mikrofon" di Pengaturan.',
