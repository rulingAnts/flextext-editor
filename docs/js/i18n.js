...
en: {
  ...
  'sat.audioUnmatched': 'No text matched these recordings, so they were left out: {names}. Give a recording the same name as its text (bird.wav beside bird.flextext).',
...
id: {
  ...
  'sat.audioUnmatched': 'Tidak ada teks yang cocok dengan rekaman ini, jadi dilewati: {names}. Beri rekaman nama yang sama dengan teksnya (bird.wav di samping bird.flextext).',
