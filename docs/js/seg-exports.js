...
${body}
<p class="note">Generated by FlexText Editor. Audio is embedded in this file — it works offline and needs no other files. Click or drag on any waveform to position the playhead; the round buttons play a line (or the whole recording) from there. <b>Press the space bar to play or pause</b>, and the page follows the line being played.</p>
<script>
(function () {
