...
en: {
  ...
  'panel.drive.modeRelay': 'Uploads go through the shared relay into your “anyone with link can edit” Drive folders (current setup).',
  'panel.drive.modeOauth': 'Uploads go directly into YOUR Google Drive (connected as {email}).',
  ...
  'panel.drive.switchOauth': 'Switch to my own Drive',
  'panel.drive.switchRelay': 'Switch back to the shared relay',
  'panel.drive.nowOauth': 'Switched — uploads now go directly into your own Google Drive.',
  'panel.drive.nowRelay': 'Switched — uploads now go through the shared relay.',
  ...
  'panel.drive.docNote': 'Full instructions: docs/drive-oauth-cutover.md in the repository.',
...
id: {
  ...
  'panel.drive.modeRelay': 'Unggahan lewat relai bersama ke folder Drive Anda yang disetel “siapa pun yang memiliki link dapat mengedit” (pengaturan saat ini).',
  'panel.drive.modeOauth': 'Unggahan masuk langsung ke Google Drive ANDA (terhubung sebagai {email}).',
  ...
  'panel.drive.switchOauth': 'Beralih ke Drive saya sendiri',
  'panel.drive.switchRelay': 'Kembali ke relai bersama',
  'panel.drive.nowOauth': 'Beralih — unggahan kini masuk langsung ke Google Drive Anda sendiri.',
  'panel.drive.nowRelay': 'Beralih — unggahan kini lewat relai bersama.',
  ...
  'panel.drive.docNote': 'Petunjuk lengkap: docs/drive-oauth-cutover.md di repositori.',
