...
en: {
  ...
  'panel.crowd.shareIframe': 'Embed on a website (iframe)',
  ...
  'panel.crowd.shareScript': 'Script snippet (advanced)',
  'panel.crowd.shareScriptNote': 'Unlike the plain iframe, this auto-fits its height to the content and blends with the page background. But many CMSes and website builders REMOVE JavaScript, which silently kills it — if in doubt, use the link or the iframe.',
...
id: {
  ...
  'panel.crowd.shareIframe': 'Sematkan di situs web (iframe)',
  ...
  'panel.crowd.shareScript': 'Potongan skrip (lanjutan)',
  'panel.crowd.shareScriptNote': 'Berbeda dari iframe biasa, ini menyesuaikan tingginya dengan isi secara otomatis dan menyatu dengan latar halaman. Namun banyak CMS dan pembuat situs MENGHAPUS JavaScript sehingga opsi ini mati tanpa tanda — jika ragu, gunakan tautan atau iframe.',
