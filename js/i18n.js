...
en: {
  ...
  'recfmt.helpRaw': '<b>Faithful, unprocessed capture.</b> This app records the raw microphone signal — automatic gain, noise reduction, and echo cancellation are all switched off. For the lossless formats, nothing is added to or removed from the original sound.',
...
id: {
  ...
  'recfmt.helpRaw': '<b>Perekaman setia, tanpa pemrosesan.</b> Aplikasi ini merekam sinyal mikrofon mentah — penguatan otomatis, pengurangan noise, dan penghapus gema semuanya dimatikan. Untuk format lossless, tidak ada yang ditambahkan ke atau dihilangkan dari suara asli.',
