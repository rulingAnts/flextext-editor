...
en: {
  ...
  'research.autoDelNote': 'Best for collecting recordings on a phone — frees storage and keeps the list to what still needs sending. Leave OFF if coworkers edit texts over several sessions. (The Text Recorder app deletes after upload by default.)',
...
id: {
  ...
  'recordlink.note': 'Buat tautan yang membuka aplikasi <em>khusus merekam</em> yang disederhanakan di HP rekan kerja — tanpa editor, tanpa glos, cukup rekam lalu kirim. Mereka bisa memasangnya sebagai aplikasi tersendiri ("Perekam Teks") dan menyimpan banyak rekaman tanpa internet. Langkah izin penutur dan folder unggahan Drive yang Anda atur di atas juga berlaku di sini.',
  ...
  'research.autoDelNote': 'Cocok untuk mengumpulkan rekaman di HP — menghemat penyimpanan dan menjaga daftar hanya berisi yang belum terkirim. Biarkan MATI jika rekan kerja menyunting teks selama beberapa sesi. (Aplikasi Perekam Teks menghapus otomatis setelah unggah.)',
