...
NO_PROXY='*' node test/worker-projectkey.probe.mjs "http://127.0.0.1:$PORT" || STATUS=1
NO_PROXY='*' node test/worker-create-idempotency.probe.mjs "http://127.0.0.1:$PORT" || STATUS=1
NO_PROXY='*' node test/worker-project-upload.probe.mjs "http://127.0.0.1:$PORT" || STATUS=1
