...
en: {
  ...
  'recformat.note': 'How new recordings are captured — here and on any phone you send a recording link to. <b>Lossless WAV/FLAC</b> keeps full quality for analysis and archiving; <b>MP3</b> is small but lossy. Lossless needs a recent Chrome, Edge, or Firefox — on other browsers it falls back to MP3 automatically (with a warning). This is the <em>captured</em> format; to make a small copy to send to an assistant, use the converter below.',
  'recformat.label': 'Format for new recordings',
  'recformat.wav32': 'WAV · 32-bit float (maximum fidelity — default)',
  'recformat.wav24': 'WAV · 24-bit',
  'recformat.wav16': 'WAV · 16-bit (smaller)',
  'recformat.flac24': 'FLAC · 24-bit (lossless, about half the size of WAV)',
  'recformat.mp3': 'MP3 (compressed — smallest, not archival)',
...
id: {
  ...
  'recformat.note': 'Cara rekaman baru direkam — di sini dan di HP mana pun yang Anda kirimi tautan perekaman. <b>WAV/FLAC lossless</b> menjaga kualitas penuh untuk analisis dan pengarsipan; <b>MP3</b> kecil tetapi kehilangan kualitas. Lossless memerlukan Chrome, Edge, atau Firefox versi terbaru — di browser lain otomatis beralih ke MP3 (dengan peringatan). Ini format <em>yang direkam</em>; untuk membuat salinan kecil yang dikirim ke asisten, gunakan pengubah di bawah.',
  'recformat.label': 'Format untuk rekaman baru',
  'recformat.wav32': 'WAV · 32-bit float (kualitas tertinggi — default)',
  'recformat.wav24': 'WAV · 24-bit',
  'recformat.wav16': 'WAV · 16-bit (lebih kecil)',
  'recformat.flac24': 'FLAC · 24-bit (lossless, sekitar separuh ukuran WAV)',
  'recformat.mp3': 'MP3 (terkompresi — paling kecil, bukan arsip)',
