...
en: {
  ...
  'recformat.agcLabel': 'Automatic gain control (clip protection)',
  'recformat.agcAuto': 'Automatic — on for Chrome/Edge, off for Firefox (recommended)',
  'recformat.agcOn': 'Always on — protects against clipping',
  'recformat.agcOff': 'Always off — fully raw level (may clip loud sound)',
  'recformat.agcNote': 'AGC continuously adjusts the level so loud sound does not <b>clip</b> (clipping permanently destroys the peaks). It does change the dynamics, so it is not ideal for acoustic analysis — but on Chrome/Edge it is the only protection against clipping, because a web app cannot lower the microphone input level. <b>Automatic</b> turns it on for Chrome/Edge and off for Firefox, which already captures a faithful, lower level. For a controlled recording where you have set the input level yourself, choose <b>Always off</b>.',
  ...
  'recfmt.helpRaw': '<b>Faithful, unprocessed capture.</b> Browsers normally apply noise reduction, echo cancellation, and voice isolation to microphone audio — this app switches all three off, so the lossless formats capture the raw signal with nothing added or removed. Browsers differ in mic input level: <b>Firefox</b> captures a faithful, lower level, while <b>Chrome/Edge</b> drive the input louder — loud enough that, with automatic gain control off, they can <b>clip</b> (permanently lose the peaks), and a web app cannot lower the hardware input level. So the app leaves automatic gain control <b>on for Chrome/Edge</b> (its only clip protection) and <b>off for Firefox</b>. You can override that in Settings — and the app never adds software gain of its own.',
...
id: {
  ...
  'recformat.agcLabel': 'Kontrol penguatan otomatis (perlindungan clipping)',
  'recformat.agcAuto': 'Otomatis — aktif untuk Chrome/Edge, mati untuk Firefox (disarankan)',
  'recformat.agcOn': 'Selalu aktif — melindungi dari clipping',
  'recformat.agcOff': 'Selalu mati — level sepenuhnya mentah (suara keras bisa clipping)',
  'recformat.agcNote': 'AGC terus menyesuaikan level agar suara keras tidak <b>clipping</b> (clipping merusak puncak secara permanen). Ini memang mengubah dinamika, jadi kurang ideal untuk analisis akustik — tetapi di Chrome/Edge inilah satu-satunya perlindungan dari clipping, karena aplikasi web tidak bisa menurunkan level masukan mikrofon. <b>Otomatis</b> mengaktifkannya untuk Chrome/Edge dan mematikannya untuk Firefox, yang sudah menangkap level lebih rendah yang setia. Untuk rekaman terkendali di mana Anda sendiri sudah mengatur level masukan, pilih <b>Selalu mati</b>.',
  ...
  'recfmt.helpRaw': '<b>Perekaman setia, tanpa pemrosesan.</b> Peramban biasanya menerapkan pengurangan noise, penghapus gema, dan isolasi suara pada audio mikrofon — aplikasi ini mematikan ketiganya, jadi format lossless menangkap sinyal mentah tanpa ada yang ditambahkan atau dihilangkan. Peramban berbeda dalam level masukan mikrofon: <b>Firefox</b> menangkap level lebih rendah yang setia, sedangkan <b>Chrome/Edge</b> mendorong masukan lebih keras — cukup keras sehingga, dengan kontrol penguatan otomatis mati, bisa <b>clipping</b> (puncak hilang permanen), dan aplikasi web tidak bisa menurunkan level masukan perangkat keras. Maka aplikasi membiarkan kontrol penguatan otomatis <b>aktif untuk Chrome/Edge</b> (satu-satunya perlindungan clipping) dan <b>mati untuk Firefox</b>. Anda bisa menggantinya di Pengaturan — dan aplikasi tidak pernah menambah penguatan perangkat lunak sendiri.',
